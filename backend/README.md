...
For Render production, set the same values in the service's environment variables (Render dashboard), especially `MONGO_URI`, `JWT_SECRET`, and `CLIENT_URL=https://YOUR-NETLIFY-SITE.netlify.app`.
